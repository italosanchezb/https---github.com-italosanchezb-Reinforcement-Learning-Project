...
\hypersetup{
  pdftitle={Proyecto Reinforcement Learning},
  pdfauthor={José Ítalo Sánchez Bermúdez},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{Proyecto Reinforcement Learning}
\author{José Ítalo Sánchez Bermúdez}
\date{Invalid Date}
...
\chapter{Formulación del MDP}\label{formulaciuxf3n-del-mdp}
